...
# Author Peter Lozano
# 07/25/2025 ########## ASK IF ITS OK TO USE INPUT FOR FILE PATH (RUN CODE TO SEE) ############################################
# ####################### Assignment Details ###########################
...
def main():
    ...
    try:
        ...
        # Example:
        # 'C:/Users/peter/OneDrive - Bellevue University/gettysburg.txt'
        file_path = input(
        ...
        print("or provide the full correct path to the file.")
        return  # Exit the program if the source file is missing.
    except Exception as e:
        print(f"An unexpected error occurred: {e}")
        return

    # Prompt the user to enter a name for the output file.
    output_filename = input("Please enter the filename for the output "
                            "(e.g., output.txt): "
    )

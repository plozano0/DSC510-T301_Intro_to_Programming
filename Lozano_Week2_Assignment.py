...
print(f"Thank you {user_name}!\n"
      ...
      f"{company_name}'s total cost is {locale.currency(total_cost)}"
      f" for {"%.2f" % number_of_feet} feet."
)
